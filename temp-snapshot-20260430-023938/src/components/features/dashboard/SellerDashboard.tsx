              ...
              >
                {isCenter ? (
                  ...
                  >
                    ...
                    <span className="text-[9px] font-normal text-white mt-1">
                      {item.label}
                    </span>
                  </button>
                ) : (
                  ...
                  >
                    ...
                    <span className="max-w-[70px] truncate whitespace-nowrap text-center text-[9px] font-normal leading-tight">
                      {item.label}
                    </span>
                  </button>
                )}
