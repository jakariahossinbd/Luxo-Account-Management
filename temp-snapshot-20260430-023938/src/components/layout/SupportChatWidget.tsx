  ...
  return (
    <div ref={rootRef} className="fixed bottom-28 right-4 z-40 flex flex-col items-end lg:right-8">
      ...
      <button
        ...
        className="relative grid h-16 w-16 place-items-center rounded-full bg-white shadow-[0_10px_24px_rgba(15,23,42,0.14)] transition dark:bg-slate-100 dark:shadow-[0_10px_24px_rgba(2,6,23,0.28)]"
