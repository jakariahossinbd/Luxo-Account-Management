            ...
            return (
              <li key={item.key} className="relative -top-5 flex justify-center">
                <button
                  ...
                  className="seller-menu-hover relative flex h-16 w-16 flex-col items-center justify-center rounded-full bg-gradient-to-br from-orange-400 via-orange-500 to-amber-600 text-white shadow-[0_8px_18px_rgba(249,115,22,0.42),inset_0_2px_0_rgba(255,255,255,0.28)] transition-all duration-300 hover:shadow-[0_16px_30px_rgba(249,115,22,0.42),0_0_0_1px_rgba(255,255,255,0.12),inset_0_2px_0_rgba(255,255,255,0.35)] active:scale-95"
                >
                  <Icon className="h-5 w-5 scale-110" />
                  <span className="mt-1 text-[9px] font-normal whitespace-nowrap text-white">{item.label}</span>
                </button>
              </li>
            );
          }
          ...
          return (
            <li key={item.key} className="flex h-full items-center justify-center">
              <button
                type="button"
                onClick={() => onNavigate(item.key)}
                className={`seller-menu-hover group relative flex h-full w-full flex-col items-center justify-center gap-0.5 px-1 py-0 transition-all duration-300 ${
              ...
              >
                ...
                <Icon className="h-5 w-5 scale-125 transition-transform duration-300 group-hover:-translate-y-0.5" />
                <span className="max-w-[70px] truncate whitespace-nowrap text-center text-[9px] font-normal leading-tight">{item.label}</span>
              </button>
            </li>
          );
        })}
