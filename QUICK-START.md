...
এটা করবে:
1. ✅ Windows sign-in এ hidden launcher register করবে
2. ✅ কোনো visible terminal window/taskbar entry ছাড়াই dev server শুরু করবে
3. ✅ পরবর্তী PC sign-in এ server auto-start করবে
