            ...
            <article className="rounded-[10px] border border-[#8ca5ad] bg-white">
              ...
              <div className="p-3 sm:p-4">
                ...
                <button
                  ...
                  className="mt-4 inline-flex w-full items-center justify-center gap-1 rounded-full bg-gradient-to-r from-[#f92020] to-[#ffbe0f] px-3 py-2 text-[13px] font-bold whitespace-nowrap text-white sm:py-3 sm:text-[24px] [text-shadow:0_1px_1px_rgba(0,0,0,0.5)]"
                >
