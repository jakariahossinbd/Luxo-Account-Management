      ...
      <div className="mx-auto flex min-h-[calc(100dvh-1rem)] w-full max-w-[410px] flex-col items-center justify-center py-2 sm:max-w-[430px] sm:py-3 lg:min-h-full lg:py-0">
        ...
        <div className="mt-1.5 text-center sm:mt-2">
          <div className="inline-flex flex-col items-center">
            <h1 className="text-[24px] font-bold leading-none tracking-[0.01em] text-[#666a70] sm:text-[34px]">
              Team Workforce
            </h1>
        ...
        <div className="mt-3 flex flex-col items-center sm:mt-4">
          <button
            ...
            className="group relative flex h-14 w-14 items-center justify-center overflow-hidden rounded-lg bg-gradient-to-b from-white via-white to-slate-100 text-slate-600 shadow-[inset_0_1px_0_rgba(255,255,255,0.95),inset_0_-5px_10px_rgba(148,163,184,0.10),0_1px_2px_rgba(15,23,42,0.06)] transition duration-200 active:scale-[0.96] sm:h-16 sm:w-16 disabled:cursor-not-allowed disabled:opacity-70"
            aria-label="Open fingerprint sign in"
          >
            <span className="pointer-events-none absolute left-1 top-1 h-4 w-4 rounded-tl-[8px] border-l-[2px] border-t-[2px] border-slate-500" />
            <span className="pointer-events-none absolute right-1 top-1 h-4 w-4 rounded-tr-[8px] border-r-[2px] border-t-[2px] border-slate-500" />
            <span className="pointer-events-none absolute bottom-1 left-1 h-4 w-4 rounded-bl-[8px] border-b-[2px] border-l-[2px] border-slate-500" />
            <span className="pointer-events-none absolute bottom-1 right-1 h-4 w-4 rounded-br-[8px] border-b-[2px] border-r-[2px] border-slate-500" />
            <Fingerprint className="relative z-10 h-8 w-8 text-slate-700 sm:h-9 sm:w-9" strokeWidth={1.8} />
          </button>
        ...
        <form onSubmit={handleLogin} autoComplete="off" className="mt-8 w-full max-w-[400px] space-y-1.5 sm:mt-12 sm:space-y-3.5">
